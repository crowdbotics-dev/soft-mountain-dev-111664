"""
Django settings for soft_mountain_dev_111664 project.
...
ROOT_URLCONF = 'soft_mountain_dev_111664.urls'
...
WSGI_APPLICATION = 'soft_mountain_dev_111664.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_mountain_dev_111664 API",
    "DESCRIPTION": "API documentation for soft_mountain_dev_111664 App",
    "VERSION": "v1",
}
